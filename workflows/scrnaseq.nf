...
include { CELLENICS_PREPROCESS } from '../subworkflows/local/cellenics_preprocess'
include { CELLENICS_UPLOAD } from '../subworkflows/local/cellenics_upload'
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
workflow SCRNASEQ {
    ...
    if (params.aligner == "kallisto") {
        ...
        // val(_), path(results_path) = KALLISTO_BUSTOOLS.out.counts
        CELLENICS_PREPROCESS(
            Channel.fromPath("Sample1_kallistobustools_count/t2g.txt"), 
